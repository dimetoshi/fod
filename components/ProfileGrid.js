...
const ProfileCard = ({ name, title, handle, description, imageUrl }) => (
  <div className="w-full h-full px-4 py-4 min-[376px]:px-6 min-[376px]:py-6 bg-neutral-950/60 backdrop-blur-sm rounded-1xl border border-neutral-700/30 flex flex-col gap-4">
...
const ProfileGrid = () => {
  ...
  return (
    <div className="w-full">
      <div className="w-full h-80 min-[481px]:h-[480px] min-[1560px]:h-[600px] relative">
        <img 
          src="https://doge-memes.b-cdn.net/doge-fod-hero-3_1.jpg"
          alt="DOGE Hero"
          className="w-full h-full object-cover"
        />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-4 min-[481px]:px-8 max-w-[1560px] mx-auto -mt-16 relative z-10 pb-8">
